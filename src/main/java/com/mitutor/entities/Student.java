...
public class Student implements Serializable {
    ...
    public Student withPoints(Float points) {
    ...
    public Student withPerson(Person person) {
        this.setPerson(person);
        return this;
    }

    public Student withQualificationCount(Integer qualificationCount) {
    ...
    public Student addTutoringSession(TutoringSession tutoringSession) {
